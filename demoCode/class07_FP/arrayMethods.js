var x = [1, 2, 3, 4];
Array.prototype.bee = 5; // New property on the built-in JS object "Array"
console.log(x.bee);
...
console.log('x after  .myFilter(): ', x); // x is untouched
...
var trekTotalWords = trekArtWords.reduce( function(a, b) { return a + b; } );
